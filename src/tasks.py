...
class MeetingPrepTasks():
    def research_task(self, agent, meeting_participants, meeting_context):
        return Task(
            ...
            expected_output=dedent(f"""\
                A detailed report summarizing key findings about each participant and
                company, highlighing information that could be relevant for the meeting.
                                   """),
            agent=agent,
    ...
    def meeting_strategy_task(self, agent, meeting_context, meeting_objective):
        return Task(
            description=dedent(f"""\
                Develop startegic talking points, questions, and discussion angles
            ...
            expected_output=dedent("""\
                ...
                to ask to help achieve the meeting objective during the meeting.
                                   """),
            agent=agent
        )
    ...
    def summary_and_briefing_task(self, agent, meeting_context, meeting_objective):
        return Task(
            description=dedent(f"""\
                Complie all the research finding, industry analysis, and strategic
